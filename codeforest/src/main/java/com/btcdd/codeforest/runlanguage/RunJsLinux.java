...
public class RunJsLinux {
	...
	public RunJsLinux(String fileName, String packagePath, String language) {
	...
	public String execCompile() {
		try {
			...
			process = Runtime.getRuntime().exec(
					"node " + packagePath + "/" + language + "/Test.js");	
	...
	public String runClass() {
		...
		buffer.append("node " + packagePath + "/" + language + "/Test.js");
